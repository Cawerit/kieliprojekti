...
function id(x) {return x[0]; }
 ...
 const kasitteleTotuusarvo = arvo => () => ({ tyyppi: 'totuusarvo', arvo }); var grammar = {
    ...
    {"name": "luku$ebnf$1", "symbols": [{"literal":"-"}], "postprocess": id},
    {"name": "luku$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "luku", "symbols": ["luku$ebnf$1", "luku$ebnf$2"], "postprocess": d => ({ tyyppi: 'numero', arvo: parseInt(flatJoin(d), 10) })},
    {"name": "luku$ebnf$3", "symbols": [{"literal":"-"}], "postprocess": id},
    {"name": "luku$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "luku$ebnf$4", "symbols": [numero]},
    {"name": "luku$ebnf$4", "symbols": ["luku$ebnf$4", numero], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "luku$ebnf$5", "symbols": [numero]},
    {"name": "luku$ebnf$5", "symbols": ["luku$ebnf$5", numero], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "luku", "symbols": ["luku$ebnf$3", "luku$ebnf$4", {"literal":"."}, "luku$ebnf$5"], "postprocess": d => ({ tyyppi: 'numero', arvo: parseFloat(flatJoin(d)) })},
