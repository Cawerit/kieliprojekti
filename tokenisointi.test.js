...
testi`;
    ...
    test('lainausmerkkien käsittely tekstissä', () => {
       const koodi = String.raw`"Tiedoston sijainti on: \"foo\\bar\""`;
       expect(tokenisoi(koodi)).toEqual([
            { tyyppi: tokentyypit.TEKSTI, arvo: String.raw`Tiedoston sijainti on: "foo\bar"`, indeksi: 0 }
       ]);
    });
});